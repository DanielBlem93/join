...
function generateToDoHTML(element, category, i, nextPosition) {
    ...
    <div class="chegeCategory">
        <img id="up" onclick="upCategory(event, ${element['id']})" src="./assets/img/up.png" style="display: ${displayUp}">
        <br>
        <img id="down" onclick="downCategory(event, ${element['id']})" src="./assets/img/down.png" style="display: ${displayDown}">
    </div>
